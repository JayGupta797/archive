...
// Wait to load geography and map data. It's a large file even after compression...
d3.queue()
    .defer(d3.csv, '../assets/data/maps/Child_Abuse_map.csv', function (d) {
    ...
    .defer(d3.json, '../assets/data/district.json')
    .awaitAll(initialize)
...
function initialize(error, results) {
    ...
    d3.select("select").on("input.foo", function() {
      ...
      if (topic == 'Sexual Violence') { var mapdata = "../assets/data/maps/Sexual_Violence_map.csv"; } 
      else if (topic == 'Federal Funding') { var mapdata = "../assets/data/maps/Federal_Funding_map.csv"; } 
      else if (topic == "DOD") { var mapdata = "../assets/data/maps/DOD_map.csv"; } 
      else if (topic == 'Public Insurance') { var mapdata = "../assets/data/maps/Public_Insurance_map.csv"; } 
      else if (topic == 'Children') { var mapdata = "../assets/data/maps/Child_Abuse_map.csv"; } 
      else if (topic == 'Veterans Affairs') { var mapdata = "../assets/data/maps/VHA_map.csv"; } 
      else if (topic == 'Juvenile Justice') { var mapdata = "../assets/data/maps/Juvenile_Justice_map.csv"; } 
      else { var mapdata = "../assets/data/maps/School_Education_map.csv"; }
