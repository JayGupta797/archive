...
d3.csv("../assets/data/bars/Child_Abuse_bar.csv", function(error, data) {
  ...
  d3.select("select").on("input", function() {
    ...
    if (topic == 'Sexual Violence') { var bardata = "../assets/data/bars/Sexual_Violence_bar.csv"; } 
    else if (topic == 'Federal Funding') { var bardata = "../assets/data/bars/Federal_Funding_bar.csv"; } 
    else if (topic == "DOD") { var bardata = "../assets/data/bars/DOD_bar.csv"; } 
    else if (topic == 'Public Insurance') { var bardata = "../assets/data/bars/Public_Insurance_bar.csv"; } 
    else if (topic == 'Children') { var bardata = "../assets/data/bars/Child_Abuse_bar.csv"; } 
    else if (topic == 'Veterans Affairs') { var bardata = "../assets/data/bars/VHA_bar.csv"; } 
    else if (topic == 'Juvenile Justice') { var bardata = "../assets/data/bars/Juvenile_Justice_bar.csv"; } 
    else { var bardata = "../assets/data/bars/School_Education_bar.csv"; }
